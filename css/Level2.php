...
<?php
	if($_POST['answer'] == '104.1.57.40' || $_POST['answer'] == '104.153.57.40'){
		echo "<script>alert(\"Bingo!!! That's right! :) \");</script>";
	}else{
		echo "<script>window.location.assign('Level1.php');alert(\"Sorry, that's a wrong answer\");</script>";
	}
?>
<nav class="navbar navbar-default navbar-fixed-top" style="background-color:maroon;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="font-size:2em; font-family:Times;color:#FFF!important">ParagonHack!</a>
    </div>
    <div>
...
<div class="row" align="center">
	<div class="col-md-offset-1 col-md-6" style="height:250px;margin-right:20px;font-size:2em;color:blue;padding:40px">
			...
			void getLocation(){<br>
				string currentLocation = "Chennai";<br>
				return currentLocation >> 1;<br>
			}<br>
	<br>
	</div>
	<div class="col-md-6" style="height:100px;height:250px;margin-right:20px;">
  ...
  <br>
	...
	<input type="button"  class = "btn-primary col-md-2 col-md-offset-5" style="height:50px" value="HackIt!">
  </p>
</form>
...
There will be two levels of clues for cracking each of the phases.
	...
	<div class="table-responsive">
		<table class="table" style="color:blue!important">
			...
			<?php
				...
				$sql = "SELECT * FROM `user` ORDER BY name LIMIT 10";
