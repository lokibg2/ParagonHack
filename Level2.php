...
$uname = $_SESSION['siD'];
	...
	if($_POST['answer'] == '104.1.57.40' || $_POST['answer'] == '104.153.57.40'){
		...
		$mysqli->query("UPDATE user SET level = 2,time=CURRENT_TIMESTAMP WHERE uname='$uname' ");

	}else{
		if($_SESSION['level'] != 2){
			echo "<script>alert(\"Sorry, that's a wrong answer\");</script>";
			sleep(5);
			echo "<script>window.location.assign('Level1.php');</script>";
		}
	}
...
<div id="main"  align = "center" class="col-md-offset-1 container  col-md-12" style="padding-top:20px;">
 Congrats on clearing level 1. The journey keeps getting trickier this time. <br>Having gained the IP address of the server, you now need <br>
 the exact country in which the server is located. <br>Good Luck! :) <br><br>
<div class="row" align="center">
	<div class="col-md-offset-3 col-md-5" style="background-color:white;height:250px;margin-right:20px;font-size:2em;color:blue;padding:40px">
